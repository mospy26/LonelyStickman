...
5. Curly braces open in next line for functions, classes, enums or structs. For conditional flow and loops, they open in the same line!
6. Commenting style for functions is the QT creator supplied commenting, member variable functions are same.
